...
switch ( $component_slug ) {
	...
	case 'widget-1':
		?>
		<aside class="footer-widget-area widget-area site-footer-focus-item" data-section="sidebar-widgets-footer-widget-1" aria-label="widget">
	...
	case 'widget-2':
		?>
		<aside class="footer-widget-area widget-area site-footer-focus-item" data-section="sidebar-widgets-footer-widget-2" aria-label="widget">
			<div class="footer-widget-area-inner site-info-inner">
				<?php
	...
	case 'widget-3':
		?>
		<aside class="footer-widget-area widget-area site-footer-focus-item" data-section="sidebar-widgets-footer-widget-3" aria-label="widget">
			<div class="footer-widget-area-inner site-info-inner">
				<?php
	...
	case 'widget-4':
		?>
		<aside class="footer-widget-area widget-area site-footer-focus-item" data-section="sidebar-widgets-footer-widget-4" aria-label="widget">
			<div class="footer-widget-area-inner site-info-inner">
				<?php
